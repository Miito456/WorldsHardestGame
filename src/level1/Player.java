...
public class Player extends JLabel implements Runnable {
    ...
    private void showLevelCompletedMenu() {
        SwingUtilities.invokeLater(() -> {
            ...
            if (choice == JOptionPane.YES_OPTION) {
                WorldsHardestGame.deathCount = 0;
                restartApplication();
    ...
    public void restartApplication() {
        WorldsHardestGame.main(new String[0]);
    ...
    public void incrementDeathCount() {
        WorldsHardestGame.deathCount++;
        WorldsHardestGame.deathLabel.setText(" Muertes: " + WorldsHardestGame.deathCount);
    }
